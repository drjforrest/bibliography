...
async def create_search_space(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create search space: {str(e)}"
        )
...
async def read_search_spaces(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch search spaces: {str(e)}"
        )
...
async def read_search_space(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch search space: {str(e)}"
        )
...
async def update_search_space(
    ...
    try:
        ...
        await session.rollback()
        raise HTTPException(
            status_code=500, detail=f"Failed to update search space: {str(e)}"
        )
...
async def delete_search_space(
    ...
    try:
        ...
        await session.rollback()
        raise HTTPException(
            status_code=500, detail=f"Failed to delete search space: {str(e)}"
        )

  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        {annotation.quote && (
          <blockquote
            className={`mt-1 border-l-2 ${getQuoteBorderColor()} pl-2 text-sm italic text-gray-600 dark:text-gray-400`}
          >
        ...
        {annotation.content && (
          <p className="font-body text-sm mt-2 text-gray-700 dark:text-gray-300">
            {annotation.content}
          </p>
        )}
